...
import com.marlonjones.voidlauncher.LogDecelerateInterpolator;
...
import com.marlonjones.voidlauncher.pageindicators.PageIndicatorDots;
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mExpandDuration = res.getInteger(com.marlonjones.voidlauncher.R.integer.config_folderExpandDuration);
        mMaterialExpandDuration = res.getInteger(com.marlonjones.voidlauncher.R.integer.config_materialFolderExpandDuration);
        mMaterialExpandStagger = res.getInteger(com.marlonjones.voidlauncher.R.integer.config_materialFolderExpandStagger);

        if (sDefaultFolderName == null) {
            sDefaultFolderName = res.getString(com.marlonjones.voidlauncher.R.string.folder_name);
        }
        if (sHintText == null) {
            sHintText = res.getString(com.marlonjones.voidlauncher.R.string.folder_hint_text);
        }
    ...
    protected void onFinishInflate() {
        ...
        mContent = (FolderPagedView) findViewById(com.marlonjones.voidlauncher.R.id.folder_content);
        mContent.setFolder(this);

        mPageIndicator = (PageIndicatorDots) findViewById(com.marlonjones.voidlauncher.R.id.folder_page_indicator);
        mFolderName = (ExtendedEditText) findViewById(com.marlonjones.voidlauncher.R.id.folder_name);
        ...
        mFooter = findViewById(com.marlonjones.voidlauncher.R.id.folder_footer);
    ...
    public void doneEditingFolderName(boolean commit) {
        ...
        if (commit) {
            Utilities.sendCustomAccessibilityEvent(
                    ...
                    getContext().getString(com.marlonjones.voidlauncher.R.string.folder_renamed, newTitle));
        }
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater().inflate(
                FeatureFlags.LAUNCHER3_DISABLE_ICON_NORMALIZATION
                        ? com.marlonjones.voidlauncher.R.layout.user_folder : com.marlonjones.voidlauncher.R.layout.user_folder_icon_normalized, null);
    }
        ...
        oa.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                Utilities.sendCustomAccessibilityEvent(
                        Folder.this,
                        AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED,
                        getContext().getString(com.marlonjones.voidlauncher.R.string.folder_closed));
                mState = STATE_ANIMATING;
            }
        });
        oa.setDuration(mExpandDuration);
    ...
    @Thunk void onDragOver(DragObject d, int reorderDelay) {
        ...
        if (mTargetRank != mPrevTargetRank) {
            ...
            if (d.stateAnnouncer != null) {
                d.stateAnnouncer.announce(getContext().getString(com.marlonjones.voidlauncher.R.string.move_to_position,
                        mTargetRank + 1));
            }
        }
    ...
    private void centerAboutIcon() {
        ...
        DragLayer.LayoutParams lp = (DragLayer.LayoutParams) getLayoutParams();
        DragLayer parent = (DragLayer) mLauncher.findViewById(com.marlonjones.voidlauncher.R.id.drag_layer);
        int width = getPaddingLeft() + getPaddingRight() + mContent.getDesiredWidth();
        int height = getFolderHeight();
    ...
    public void onDrop(DragObject d) {
        ...
        if (d.stateAnnouncer != null) {
            d.stateAnnouncer.completeAction(com.marlonjones.voidlauncher.R.string.item_moved);
        }
    }
